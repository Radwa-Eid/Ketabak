...
let filterationBtn = document.getElementById("filterationBtn");
let filterationBtn2 = document.getElementById("filterationBtn2");
let cardsFiltarationList = document.querySelector(".cardsFiltaration--list");
let filterSection = document.querySelector(".filterSectionRemove");
let filterSection2 = document.querySelector(".popup-filtration-menu");
let rbtfilteration = document.querySelector(".rbt-filteration");
let closeBtn = document.getElementById("closeFilter");
filterationBtn.addEventListener("click", function () {
  cardsFiltarationList.classList.toggle("pr--26");
  filterSection.classList.toggle("filterSection");
  rbtfilteration.classList.toggle("filteration--section--h");
});
filterationBtn2.addEventListener("click", function () {
  filterSection2.classList.add("active");
  closeBtn.addEventListener("click", function () {
    filterSection2.classList.remove("active");
  });
});
